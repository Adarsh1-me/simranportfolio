          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.span
                ...
                className="inline-block px-4 py-2 rounded-full bg-primary-foreground/10 text-primary-foreground/90 text-sm font-medium mb-6 border border-primary-foreground/20"
              >
