...
const certificates = [
  { title: "Healthcare Management Certificate", issuer: "ICL Graduate Business School, Auckland", year: "2025" },
  { title: "Medical Biotechnology Degree", issuer: "University of Delhi, India", year: "2022" },
  { title: "Health Education Training", issuer: "New Green Field School, Delhi", year: "2024" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative mx-auto max-w-md lg:max-w-lg">
                ...
                >
                  <div 
                    className="relative rounded-3xl overflow-hidden shadow-3d border-2 border-primary-foreground/20 cursor-pointer"
                    onClick={() => setLightboxOpen(true)}
                  >
                    <img
                      src={simranHero}
                      alt="Simran - Healthcare Management Professional"
              ...
              <div className="p-8 md:p-12 cursor-pointer">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <motion.div
                      initial={false}
                      animate={{ height: introExpanded ? "auto" : 0, opacity: introExpanded ? 1 : 0 }}
                  ...
                  <motion.div
                    animate={{ rotate: introExpanded ? 180 : 0 }}
                    transition={{ duration: 0.3 }}
      ...
      <section className="py-24 section-dark relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "About Me", description: "Learn about my background, aspirations, and strengths", path: "/about", icon: "👤" },
              { title: "Projects", description: "View my experience in healthcare education and coordination", path: "/projects", icon: "📋" },
              { title: "Professional Development", description: "See my career goals and learning objectives", path: "/development", icon: "📈" },
              { title: "Reflective Learning", description: "Read my reflections on key learning experiences", path: "/reflective", icon: "📝" },
              { title: "Contact", description: "Get in touch for opportunities and collaboration", path: "/contact", icon: "✉️" },
            ].map((item, index) => (
              <motion.div
                key={item.path}
                initial={{ opacity: 0, y: 30 }}
